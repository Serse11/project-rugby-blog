    ...
    <section class="container-form-text">
        ...
        <div class="container-form">
            <div class="container-text-form">
                <p class="text-form">Contactez nous directement 🏉</p>
            </div>
            <form id="contact" class="form">
                ...
                <div class="form-field">             
                    <label for="message">Pour finir, votre message<i>(Requis 25 à 300 caractères)</i></label>
                    <textarea name="message" id="message" cols="40" rows="10"></textarea>
                </div>
                <div class="form-field" id="btn">
                    <input type="Submit" value="Envoyez votre message" class="input-btn">
                </div>
            </form>
        </div>
    </section>
